...
if __name__ == "__main__":
    ...
    images_bbox = False
    output_basename = f'videos_ft_5k_{args["width"]}_{args["height"]}_roshan_100s_nospa_reproduce_train_fixed'

    # videos_ft_5k_576_320_roshan_100s_50pretrain_reproduce_train_fixed
    # output_basename = f'videos_ori_{args["width"]}_{args["height"]}_roshan_100s_reproduce_train_fixed'

    # Load validation images and control images

    # Load and set up the pipeline
    controlnet = controlnet = ControlNetSDVModel.from_pretrained("/minimax-3d-rw/tuolaji/fyp/svd_trajectory/model_out_vipseg_ft_5k_100s_nospa_roshan/checkpoint-100000", subfolder="controlnet")
    # controlnet = controlnet = ControlNetSDVModel.from_pretrained("/minimax-3d-rw/tuolaji/fyp/svd_trajectory/model_out_vipseg_ft_5k_100s_50s_pretrain_reproduce_roshan/checkpoint-100000",subfolder="controlnet")
    # controlnet = controlnet = ControlNetSDVModel.from_pretrained("/minimax-3d-rw/tuolaji/fyp/svd_trajectory/model_out_vipseg_ori_100s_reproduce_roshan/checkpoint-100000",subfolder="controlnet")
    ...
    # validation_images_ft_5k_100s_576_320_roshan_100s_50pretrain_reproduce_train_fixed
    # val_save_dir = os.path.join(args["output_dir"], f'validation_images_ori_100s_{args["width"]}_{args["height"]}_roshan_100s_reproduce_train_fixed')
    val_save_dir = os.path.join(args["output_dir"], f'validation_images_ft_5k_{args["width"]}_{args["height"]}_roshan_100s_nospa_reproduce_train_fixed')
