...
from models.controlnet_sdv_bbox import ControlNetSDVModel
...
class StableVideoDiffusionPipelineControlNet(DiffusionPipeline):
    ...
    def __call__(
        ...
        print(controlnet_condition.shape, "infer_traj")
        ...
        controlnet_bbox = self.image_processor.preprocess(controlnet_bbox, height=height, width=width)
        controlnet_bbox = controlnet_bbox.repeat(controlnet_condition.shape[1], 1, 1, 1)
        print(controlnet_bbox.shape, "infer_bbox")
        controlnet_bbox = controlnet_bbox.unsqueeze(0)
        controlnet_bbox = torch.cat([controlnet_bbox] * 2) 
        controlnet_bbox = controlnet_bbox.to(device, latents.dtype)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                down_block_res_samples, mid_block_res_sample = self.controlnet(
                    ...
                    controlnet_bbox=controlnet_bbox,
