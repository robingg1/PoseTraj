...
if __name__ == "__main__":
    ...
    images_bbox = False
    output_basename = f'videos_ft_10k_{args["width"]}_{args["height"]}'

    # Load validation images and control images

    # Load and set up the pipeline
    controlnet = controlnet = ControlNetSDVModel.from_pretrained("model_out_vipseg_ft/checkpoint-100000", subfolder="controlnet")
    ...
    data_path = "dataset/VIPSeg"
    split_path = "dataset/VIPSeg/val.txt"
    ...
    for vid_folder in sorted(vid_folders):
        ...
        if len(all_images) == 1:
            ...
            json_path = os.path.join("dataset/VIPSeg_Test/test_traject", f"{vid_folder}.json")
